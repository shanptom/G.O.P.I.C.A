 ...
 **💡 Pro Tip**: For phylogeny-based analyses, your phyloseq object must include a phylogenetic tree. See our [phyloseq creation guide](https://github.com/shanptom/metaX/blob/main/docs/Phyloseq.md) for instructions.
